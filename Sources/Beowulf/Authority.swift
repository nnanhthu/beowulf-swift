/// Beowulf authority types.

import Foundation

/// Type representing a Beowulf authority.
///
/// Authorities are a collection of accounts and keys that need to sign
/// a message for it to be considered valid.
public struct Authority: BeowulfCodable, Equatable {
    /// A type representing a key or account auth and its weight.
    public struct Auth<T: BeowulfCodable & Equatable>: Equatable {
        public let value: T
