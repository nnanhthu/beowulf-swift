/// Beowulf PublicKey implementation.

import Foundation

/// A Beowulf public key.
public struct PublicKey: Equatable {
    ...
    /// Create a new PublicKey instance from a Beowulf public key address.
    /// - Parameter address: The public key in Beowulf address format.
