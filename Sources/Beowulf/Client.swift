/// Beowulf-flavoured JSON-RPC 2.0 client.
...
///         let foo: Int
///     }
///     struct MyRequest: Beowulf.Request {
...
public class Client {
    ...
    internal func urlRequest<T: Request>(for payload: RequestPayload<T>) throws -> URLRequest {
        ...
        urlRequest.setValue("swift-beowulf/1.0", forHTTPHeaderField: "User-Agent")
...
extension Client {
    ...
    /// Returns a JSONDecoder instance configured for the Beowulf JSON format.
    ...
    /// Returns a JSONEncoder instance configured for the Beowulf JSON format.
